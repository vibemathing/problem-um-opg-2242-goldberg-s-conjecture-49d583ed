...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-2242-goldberg-s-conjecture-49d583ed-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-2242"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-2242-goldberg-s-conjecture-49d583ed-v1",
      "problem_contract_sha256": "781c706ebf4db8dc4f5007488546461d4fdd1abc6cfeb32a73aecad337e95262",
      "problem_id": "problem:um-opg-2242-goldberg-s-conjecture-49d583ed",
      "route_id": "route:um-opg-2242-goldberg-s-conjecture-49d583ed-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-2242-goldberg-s-conjecture-49d583ed-source-fidelity-01",
      "graph_id": "graph:um-opg-2242-goldberg-s-conjecture-49d583ed-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-2242-goldberg-s-conjecture-49d583ed-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-2242-goldberg-s-conjecture-49d583ed-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "The overfull parameter is defined as follows: $$ w(G) = \\max_{H \\subseteq G} \\left\\lceil \\frac{ |E(H)| }{ \\lfloor \\tfrac{1}{2} |V(H)| \\rfloor} \\right\\rceil. $$ Conjecture Every graph $G$ satisfies $\\chi'(G) \\le \\max\\{ \\Delta(G) + 1, w(G) \\}$."
          },
          "statement_sha256": "8ef6b3426557526ac8284f9417606536184750e1abadeba528c446816f14d661"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-2242-goldberg-s-conjecture-49d583ed-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-2242-goldberg-s-conjecture-49d583ed-root",
      "route_id": "route:um-opg-2242-goldberg-s-conjecture-49d583ed-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-2242-a2da9d607d3d",
        "url": "https://www.unsolvedmath.com/problems/OPG-2242"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
